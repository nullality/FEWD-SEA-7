...
function tesseract_footer_branding_output() {
	...
	echo '<div id="footer-banner-right" class="designer"><div class="table"><div class="table-cell" style="display:none;">';
...
?>
		...
		<div id="unbranding-plugin-notice" class="updated notice" style="display:none;">

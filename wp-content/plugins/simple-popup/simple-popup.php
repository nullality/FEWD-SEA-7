...
if ( !class_exists( "SimplePopup" ) ) {
	class SimplePopup {
		...
		function install() {
			...
			add_option( 'popup_box_border_width', '3', '', 'yes' );
...
if ( isset( $_GET['page'] ) && $_GET['page'] == 'simple-popup/simple-popup.php' ) {
	header( 'Location: http://muneeb.me/wordpress-simple-popup-plugin/?ref=pro_link' );
	exit;
}

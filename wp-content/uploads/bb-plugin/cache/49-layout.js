...
var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://endsoftheearth.byethost22.com/FinalProject/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://endsoftheearth.byethost22.com/FinalProject/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);function initMap(map,position,zoom){map.setCenter(position);map.setZoom(zoom);var marker=new google.maps.Marker({position:position,map:map});}var position={lat:47.5758638,lng:-122.33374120000002};initMap(new google.maps.Map(document.getElementById('map-module-56d94332f3417'),{scrollwheel:false}),position,11);var wpAjaxUrl='http://endsoftheearth.byethost22.com/FinalProject/wp-admin/admin-ajax.php';var flBuilderUrl='http://endsoftheearth.byethost22.com/FinalProject/wp-content/plugins/beaver-builder-lite-version/';